...
<tr>
    ...
    <td>{{ $details ['student']['mname'] ?? 'N/A'}}</td>
</tr>
<tr>
    <td>6</td>
...
<tr>
    ...
    <td>{{ $details ['student']['dob'] ?? 'N/A'}}</td>
</tr>
<tr>
    <td>11</td>
    <td><b>Discount</b></td>
    <td>{{ $details ['discount']['discount'] ?? 'N/A'}} %</td>
</tr>
<tr>
    <td>12</td>
    <td><b>Year</b></td>
...
<tr>
    ...
    <td>{{ $details ['study_type']['name'] ?? 'N/A'}}</td>
</tr>
<tr>
    <td>15</td>
    <td><b>Study Time</b></td>
    <td>{{ $details ['study_time']['name']?? 'N/A'}}</td>
</tr>
<tr>
    <td>16</td>
