    ...
    <div class="container-full">
        ...
        <section class="content">
            ...
            <div class="box">
                ...
                <h4 class="box-title">កែប្រែព័ត៌មានបុគ្គលិក</h4>
                </div>
                <!-- /.box-header -->
                <div class="box-body">
                    <div class="row">
                        <div class="col">
                            <form method="post" action="{{ route('update.employee.registration',$editData) }}" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <div class="col-12">	
                                    ...
                                    <div class="row"> <!-- 1st Row -->
                                        ...
                                        <div class="col-md-4">     
                                            <div class="form-group">
                                                <h5 class="fontadd">ឈ្មោះឪពុក <span class="text-danger">*</span></h5>
                                                <div class="controls">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <h5 class="fontadd">ឈ្មោះម្តាយ  <span class="text-danger">*</span></h5>
                                                <div class="controls">
                                    ...
                                    <div class="row"><!-- 2st Row Start -->
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <h5 class="fontadd">លេខទូរស័ព្ទ<span class="text-danger">*</span></h5>
                                            <div class="controls">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <h5 class="fontadd">អាសយដ្ឋាន<span class="text-danger">*</span></h5>
                                            <div class="controls">
                                    ...
                                    <div class="row"><!-- 3rd Row Start -->
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <h5 class="fontadd">ខែ-ថ្ងៃ-ឆ្នាំ កំណើត<span class="text-danger">*</span></h5>
                                                <div class="controls">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <h5 class="fontadd">តំណែងការងារ<span class="text-danger">*</span></h5>
                                                <div class="controls">
                                            ...
                                            <div class="form-group">
                                                <div class="controls">
                                                    <img id="showImage" src="{{ (!empty($editData->image))? 
                                                        url('upload/employee_images/'.$editData->image):url('upload/no_image.jpg') }}" 
                                    ...
                                    <div class="row"><!-- 4th Row Start -->
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                <h5 class="fontadd">ប្រាក់ខែ<span class="text-danger">*</span></h5>
                                                <div class="controls">
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                <h5 class="fontadd">ខែ-ថ្ងៃ-ឆ្នាំ ថ្ងៃចូល<span class="text-danger">*</span></h5>
                                                <div class="controls">
