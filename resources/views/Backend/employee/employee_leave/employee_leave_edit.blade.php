    ...
    <div class="container-full">
        ...
        <section class="content">
            ...
            <div class="box">
                ...
                <h4 class="box-title">កែប្រែព័ត៌មាន​បុគ្គលិកសុំច្បាប់</h4>
                </div>
                <!-- /.box-header -->
                <div class="box-body">
                    <div class="row">
                        <div class="col">
                            ...
                            @csrf
                                ...
                                <div class="row"> 
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <h5 class="fontadd">កាលបរិច្ឆេទសុំច្បាប់<span class="text-danger">*</span></h5>
                                        <div class="controls">
                                            <input type="date" name="start_date" class="form-control" value="{{ $editData->start_date}}">                                                                                           </div>
                                        </div>
                                    </div><!-- End Col-md-6 -->

                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <h5 class="fontadd">គោលបំណងនៃកាសុំច្បាប់ <span class="text-danger">*</span></h5>
                                            <div class="controls">
                                                <select name="leave_purpose_id" id="leave_purpose_id" required="" class="form-control">
                                                    ...
                                                    <input type="text" name="name" id="add_another" class="form-control" placeholder="wirte Purpose" style="display: none;">
                                                </select>
                                            </div>
                                        </div>
                                    </div><!-- End Col-md-6 -->
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <h5 class="fontadd">ថ្ងៃបញ្ចប់នៃកាឈប់សម្រាក <span class="text-danger">*</span></h5>
                                        <div class="controls">
