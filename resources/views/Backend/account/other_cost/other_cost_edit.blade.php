    ...
    <div class="container-full">
        ...
        <section class="content">
            ...
            <div class="box">
                ...
                <h4 class="box-title">កែព័ត៌មានការចំណាយផ្សេងៗ</h4>
                </div>
                <!-- /.box-header -->
                <div class="box-body">
                    <div class="row">
                            ...
                            <div class="row">
                                <div class="col-12">	
                                    <div class="row"><!-- 1st Row Start -->
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <h5 class="fontadd">កាលបរិច្ឆេទចំណាយ<span class="text-danger">*</span></h5>
                                                <div class="controls">
                                    ...
                                    <div class="row"><!-- 1nd Row Start -->
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <h5 class="fontadd">បរិយាយ <span class="text-danger">*</span></h5>
                                                <div class="controls">
