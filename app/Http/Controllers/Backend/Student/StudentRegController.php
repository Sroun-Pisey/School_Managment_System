...
class StudentRegController extends Controller
{
    ...
    public function StudentRegAdd(){
        ...
        $data['study_times'] = StudyTime::all();
    ...
    public function StudentRegStore(Request $request){
        ...
        $assign_student->subject_id = $request->subject_id;
        $assign_student->class_id = $request->class_id;
        $assign_student->year_id = $request->year_id;
        $assign_student->study_time_id = $request->study_time_id;
        $assign_student->study_type_id = $request->study_type_id;
        $assign_student->save();


        $discount_student = new DiscountStudent();
        $discount_student->assign_student_id = $assign_student->id;
        $discount_student->fee_category_id = $assign_student->study_type_id;
    ...
    public function StudentRegPromotion($student_id){
        ...
        $data['editData'] = AssignStudent::with(['student','discount'])->where('student_id',$student_id)->first();
        //dd($data['editData']->toArray());        
        return view('Backend.student.student_reg.student_reg_promotion',$data);
